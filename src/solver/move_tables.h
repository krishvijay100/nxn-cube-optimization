...
//
// Layout: table[coord][move]:keeps the 18 (or 10) possible next-coords
// for a given current coord contiguous in memory (a single cache line holds
// all of them)
...
// Convert a Move to its dense G1 index [0-9]
